...
def getweather():
    ...
    #current
    #wind = json_data['main']['wind'][0]['speed']
...
long_lat.place(x=700, y=90)

#clock
clock = Label(weather, font=("Helvetica", 17, 'bold'), fg="white", bg="#72A0C1")
clock.place(x=30, y=150)

#wthpd
w = Label(weather, text="wind", font=("Helvetica", 11), fg="white", bg="#72A0C1")
w.place(x=200, y=230)
...
#second cell
secondbox = Frame(weather, width=100, height=130,highlightthickness=1,  bg="#72A0C1")
...
#third cell
thirdbox = Frame(weather, width=100, height=130,highlightthickness=1, bg="#72A0C1")
thirdbox.place(x=330, y=450)
...
#fourth cell
fourthbox = Frame(weather, width=100, height=130,highlightthickness=1, bg="#72A0C1")
fourthbox.place(x=440, y=450)
...
#fifth cell
fifthbox = Frame(weather, width=100, height=130, highlightthickness=1, bg="#72A0C1")
fifthbox.place(x=550, y=450)
...
#sixth cell
sixthbox = Frame(weather, width=100, height=130, highlightthickness=1, bg="#72A0C1")
sixthbox.place(x=660, y=450)
...
#seventh cell
seventhbox = Frame(weather, width=100, height=130, highlightthickness=1,highlightcolor="red", background="#0093AF", bg="#72A0C1")
seventhbox.place(x=770, y=450)
